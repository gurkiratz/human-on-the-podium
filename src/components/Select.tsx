    ...
    <label className="block min-w-0">
      ...
      <div className="material relative min-w-0 rounded-xl">
        ...
        >
          ...
          {options.map((o) => (
            <option key={o.value} value={o.value} className="bg-[#17171a]">
              {o.label}
            </option>
          ))}
        </select>
        <svg
          aria-hidden
          viewBox="0 0 12 12"
          className="pointer-events-none absolute right-3 top-1/2 h-3 w-3 -translate-y-1/2 fill-none stroke-[var(--faint)]"
          strokeWidth="1.6"
          strokeLinecap="round"
